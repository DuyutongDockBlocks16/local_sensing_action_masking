...
def parse_args(args, parser):
    ...
    parser.add_argument("--lsam", type=int, default=0, help="Whether to use lsam")
...
def main(args):
    ...
    # --n_rollout_threads 4
    # python train.py --map a --lsam 0 --num_env_steps 1000000 --n_rollout_threads 4
    ...
    # run dir
    run_dir = (
        Path(os.path.split(os.path.dirname(os.path.abspath(__file__)))[0] + "/light_mappo/results")
        / all_args.env_name
...
# tensorboard --logdir=run19:./run19,run20:./run20
# tensorboard --logdir=./run19
